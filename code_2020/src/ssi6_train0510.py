...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv3d(1,16,kernel_size=(6,3,3),stride=1,padding=1,bias=True), #conv3d:(in_channal,out_channals,kernel...)
        ...
        self.conv4 = nn.Sequential(
            nn.Conv3d(1,16,kernel_size=(6,3,3),stride=1,padding=1,bias=True),
        ...
        self.dense1 = nn.Sequential(
            nn.Linear(32768, 4096), # 卷积核3*3*16， 64-3+1=62， 输出62*62*16
            nn.LeakyReLU(),   
            nn.Dropout(0.2))
