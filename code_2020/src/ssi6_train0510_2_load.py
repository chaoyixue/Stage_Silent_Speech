...
def SSIDatasets():
    ...
    # train_lips = train_lips[25001:50005,:,:,:]
    # train_tongue = train_tongue[25001:50005,:,:,:]
    # train_label = train_label[25001:50000,:]
    train_lips = train_lips[50001:,:,:,:]
    train_tongue = train_tongue[50001:,:,:,:]
    train_label = train_label[50001:,:]
...
if __name__ == "__main__":
    ...
    plt.ylabel('loss')
    plt.grid(True)
    plt.savefig(root+"epoch_loss3.png")
    ...
    plt.grid(True)
    plt.savefig(root+"eval_loss3.png")
