...
class CNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = self.cnn2d(i,64)
        self.conv2 = self.cnn2d(64,128)
        self.conv3 = self.cnn2d(128,256)
        # self.conv7 = self.cnn2d(256,512)
        # self.conv8 = self.cnn2d(512,1024)

        self.conv4 = self.cnn2d(i,64)
        self.conv5 = self.cnn2d(64,128)
        self.conv6 = self.cnn2d(128,256)
        # self.conv9 = self.cnn2d(256,512)
        # self.conv10 = self.cnn2d(512,1024)
