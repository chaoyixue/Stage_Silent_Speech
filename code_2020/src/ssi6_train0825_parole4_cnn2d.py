...
def SSIDatasets():
    ...
    #(12, 76211, 1) (12, 8468, 1) (76211, 1) (8466, 1) (76210, 736) (8467, 736) (76211, 1) (8466, 1)
    ...
    print(train_lsf.shape, test_lsf.shape, train_f0.shape, test_f0.shape, train_label.shape, test_label.shape, train_uv.shape, test_uv.shape )
    #(12, 76210, 1) (12, 8466, 1) (76210, 1) (8466, 1) (76209, 736) (8467, 736) (76210, 1) (8466, 1)
    ...
    #change dimension match: (12,x,1) --> (x,1,12)
