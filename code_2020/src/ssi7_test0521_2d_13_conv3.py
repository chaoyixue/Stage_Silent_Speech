...
from ssi6_train0521_256_13_conv3 import CNN, match_image_label
...
def TestDatasets2():
    ...
    print('[INFO] set datasets')
    _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_lips = test_lips[:412,:,:,:]
    test_tongue = test_tongue[:412,:,:,:]
...
def TestDatasets3():
    ...
    print('[INFO] set datasets')
    _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_lips = test_lips[400:812,:,:,:]
    test_tongue = test_tongue[400:812,:,:,:]
