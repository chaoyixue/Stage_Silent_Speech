...
from ssi6_train0618_parole4 import CNN, match_image_label
...
def TestDatasets1():
    ...
    test_lips = test_lips[200:400+i-1,:,:,:]
    test_tongue = test_tongue[200:400+i-1,:,:,:]
    test_label = test_label[200:400,:]
...
def TestDatasets2():
    ...
    print('[INFO] set datasets')
    _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_lips = test_lips[400:600+i-1,:,:,:]
    test_tongue = test_tongue[400:600+i-1,:,:,:]
    test_label = test_label[400:600,:]
...
def TestDatasets3():
    ...
    print('[INFO] set datasets')
    _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_lips = test_lips[800:1000+i-1,:,:,:]
    test_tongue = test_tongue[800:1000+i-1,:,:,:]
...
if __name__ == "__main__":
    ...
    np.save(root+"test_predict_me1_.npy", spec1)
    ...
    np.save(root+"test_predict_me2_.npy", spec2)
    ...
    np.save(root+"test_predict_me3_.npy", spec3)
