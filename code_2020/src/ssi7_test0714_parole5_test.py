...
from ssi6_train0707_parole4_cnnlstm import CNN_LSTM, match_image_label
...
if __name__ == "__main__":
    ...
    np.save(root+"test_predict_me3_nograd.npy", spec3)
    ...
    np.save(root+"test_predict_me4_nograd.npy", spec4)
