...
def TestDatasets1(test_lips, test_tongue, test_label):
...
def TestDatasets2(test_lips, test_tongue, test_label):
    print('[INFO] -------------------------------------------------')
    print('[INFO] set datasets')
    # _, test_lips, _, test_tongue, _, test_label = load_dataset()
...
def TestDatasets3(test_lips, test_tongue, test_label):
    print('[INFO] -------------------------------------------------')
    print('[INFO] set datasets')
    # _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_lips = test_lips[800:1200+i-1,:,:,:]
    test_tongue = test_tongue[800:1200+i-1,:,:,:]
    test_label = test_label[800:1200,:]
...
def TestDatasets4(test_lips, test_tongue, test_label):
    print('[INFO] -------------------------------------------------')
    print('[INFO] set datasets')
    # _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_lips = test_lips[1200:1600+i-1,:,:,:]
    test_tongue = test_tongue[1200:1600+i-1,:,:,:]
    test_label = test_label[1200:1600,:]
...
if __name__ == "__main__":
    ...
    _, test_lips, _, test_tongue, _, test_label = load_dataset()
    test_datasets1, test_loader1 = TestDatasets1(test_lips, test_tongue, test_label)
    ...
    test_datasets2, test_loader2 = TestDatasets2(test_lips, test_tongue, test_label)
    print('[INFO] begin test')
    ...
    test_datasets3, test_loader3 = TestDatasets3(test_lips, test_tongue, test_label)
    print('[INFO] begin test')
    ...
    test_datasets4, test_loader4 = TestDatasets4(test_lips, test_tongue, test_label)
    print('[INFO] begin test')
