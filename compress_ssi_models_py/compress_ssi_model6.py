...
def compress_ssi_model6():
    ...
    lips_conv5 = Conv2D(256, (3, 3), padding="same", activation="relu")
    lips_tm5 = TimeDistributed(lips_conv5)(lips_pooling4)
    lips_pooling5 = TimeDistributed(AveragePooling2D())(lips_tm5)
    ...
    tongues_conv5 = Conv2D(256, (3, 3), padding="same", activation="relu")
    tongues_tm5 = TimeDistributed(tongues_conv5)(tongues_pooling4)
    tongues_pooling5 = TimeDistributed(AveragePooling2D())(tongues_tm5)
...
########################################################################################################################
    ...
    filepath = "compress_ssi_model6_linear_bs128/compress_ssi_model6_linear_bs128-{epoch:02d}-{val_loss:.8f}.h5"
