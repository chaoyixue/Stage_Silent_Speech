...
if __name__ == "__main__":
    ...
    Y = np.load("spectrogrammes_all_chapitres_coupe.npy")
    ...
    validation_label = np.load("validation_spectrum_coupe.npy")[2:-2]
    ...
    filepath = "ssi_cnnlstm_model1_data_coupe/ssi_cnnlstm_model1_data_coupe-{epoch:02d}-{val_loss:.8f}.h5"
