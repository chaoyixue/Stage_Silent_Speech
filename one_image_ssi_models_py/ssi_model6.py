...
def two_input_one_output_model():
    ...
    tongues_dr1 = Dropout(0.2)(tongues_bn1)
    ...
    tongues_dr2 = Dropout(0.2)(tongues_bn2)
    ...
    tongues_dr3 = Dropout(0.2)(tongues_bn3)
    ...
    tongues_dr4 = Dropout(0.2)(tongues_bn4)
...
if __name__ == "__main__":
    ...
    filepath = "ssi_model6/weights-improvement-{epoch:02d}-{val_loss:.8f}.h5"
