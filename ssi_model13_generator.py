"""
This file load images from the hard drive for each batch and training on it
"""
import numpy as np
...
def ssi_model_13():
    ...
    lips_conv5_1 = TimeDistributed(Conv2D(256, (3, 3), padding="same", activation="relu"))(lips_pooling4)
    lips_conv5_2 = TimeDistributed(Conv2D(256, (3, 3), padding="same", activation="relu"))(lips_conv5_1)
    lips_pooling5 = TimeDistributed(MaxPooling2D(pool_size=(2, 2)))(lips_conv5_2)
    ...
    tongues_conv5_1 = TimeDistributed(Conv2D(256, (3, 3), padding="same", activation="relu"))(tongues_pooling4)
    tongues_conv5_2 = TimeDistributed(Conv2D(256, (3, 3), padding="same", activation="relu"))(tongues_conv5_1)
    tongues_pooling5 = TimeDistributed(MaxPooling2D(pool_size=(2, 2)))(tongues_conv5_2)
