...
def two_input_one_output_model():
    ...
    lips_conv7 = Conv2D(128, (3, 3), padding="same", activation="relu")(lips_pooling3)
    ...
    lips_conv9 = Conv2D(256, (3, 3), padding="same", activation="relu")(lips_pooling4)
    ...
    tongues_conv7 = Conv2D(128, (3, 3), padding="same", activation="relu")(tongues_pooling3)
    ...
    tongues_conv9 = Conv2D(256, (3, 3), padding="same", activation="relu")(tongues_pooling4)
...
if __name__ == "__main__":
    ...
    filepath = "ssi_model5_no_bn_dr/weights-improvement-{epoch:02d}-{val_loss:.8f}.h5"
