...
def two_input_one_output_model():
    ...
    lips_conv3 = Conv2D(32, (3, 3), padding="same", activation="relu")(lips_bn1)
    ...
    lips_conv5 = Conv2D(64, (3, 3), padding="same", activation="relu")(lips_bn2)
    ...
    lips_conv7 = Conv2D(128, (3, 3), padding="same", activation="relu")(lips_bn3)
    ...
    lips_conv9 = Conv2D(256, (3, 3), padding="same", activation="relu")(lips_bn4)
    ...
    tongues_conv3 = Conv2D(32, (3, 3), padding="same", activation="relu")(tongues_bn1)
    ...
    tongues_conv5 = Conv2D(64, (3, 3), padding="same", activation="relu")(tongues_bn2)
    ...
    tongues_conv7 = Conv2D(128, (3, 3), padding="same", activation="relu")(tongues_bn3)
    ...
    tongues_conv9 = Conv2D(256, (3, 3), padding="same", activation="relu")(tongues_bn4)
...
if __name__ == "__main__":
    ...
    filepath = "ssi_model5_no_dr/weights-improvement-{epoch:02d}-{val_loss:.8f}.h5"
