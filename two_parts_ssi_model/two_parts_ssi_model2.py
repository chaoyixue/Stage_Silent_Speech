...
def two_parts_ssi_model2():
    input_lips = Input(shape=(64, 64, 1))
    lips_conv1 = Conv2D(6, (3, 3), padding="same", activation="relu")(input_lips)
    lips_pooling1 = AveragePooling2D()(lips_conv1)
    lips_conv2 = Conv2D(16, (3, 3), padding="same", activation="relu")(lips_pooling1)
    ...
    tongues_conv1 = Conv2D(6, (3, 3), padding="same", activation="relu")(input_tongues)
    tongues_pooling1 = AveragePooling2D()(tongues_conv1)
    tongues_conv2 = Conv2D(16, (3, 3), padding="same", activation="relu")(tongues_pooling1)
...
if __name__ == "__main__":
    ...
    test_model = two_parts_ssi_model2()
    test_model.summary()
